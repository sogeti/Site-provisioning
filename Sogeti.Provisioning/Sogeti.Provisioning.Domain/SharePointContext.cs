...
namespace Sogeti.Provisioning.Domain
{
    ...
    public abstract class SharePointContext
    {
		...
		public static String CloneQueryString(HttpRequest httpRequest)
		{
			return CloneQueryString(new HttpRequestWrapper(httpRequest));
		}

		public static String CloneQueryString(HttpRequestBase httpRequest)
		{
			if (httpRequest == null)
			{
			...
			{
				result += String.Format("&{0}={1}", k, HttpUtility.UrlEncode(httpRequest.QueryString[k]).Replace("+", "%20"));
			}
